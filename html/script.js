...
$(document).on('click', '.New-NUI-Style', function(e){
    ...
    $(".SelectChar-SpawnChar").css({"background":"#008000"});
...
$(document).on('click', '#CreateCharExpert', function (e) {
    ...
    if(AccessCreate){
        ...
        console.log("You can create upto 5 character")
    }
});
...
$(document).on('click', '.Expert-Register-ImageStyle', function(e){
    ...
    if(genders == "man"){
        ...
        $('#Expert-man').attr('src','https://cdn.discordapp.com/attachments/1111922863331606591/1124695109309571223/male.png');
        $('#Expert-woman').attr('src','https://cdn.discordapp.com/attachments/1111922863331606591/1124677388589092944/female.png');
    }else{
        SelectedCharGender = "Female"
        $('#Expert-woman').attr('src','https://cdn.discordapp.com/attachments/1111922863331606591/1124694207534207026/female.png');
        $('#Expert-man').attr('src','https://cdn.discordapp.com/attachments/1111922863331606591/1124677410168778892/male.png');
    }
});
